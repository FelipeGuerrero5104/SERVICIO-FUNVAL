...
export default function ServiceForm({ service, onClose, onSuccess }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg max-w-lg w-full p-6 dark:bg-slate-900 dark:text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select
              ...
              className="w-full border rounded px-3 py-2 dark:bg-[#2b2b2b]"
              required
            >
          ...
          <div className="flex gap-3">
            <button
              type="submit"
              disabled={loading}
              className="bg-gradient-to-br from-[#2196f3] to-[#0d47a1] hover:bg-gradient-to-br hover:from-[#1e88e5] hover:to-[#12345a] text-white px-4 py-2 rounded hover:bg-blue-600 disabled:opacity-50"
            >
            ...
            <button
              ...
              onClick={onClose}
              disabled={loading}
              className=" text-white px-4 py-2 rounded bg-gradient-to-br from-neutral-600 to-neutral-700 hover:bg-gradient-to-br hover:from-neutral-700 hover:to-neutral-900 disabled:opacity-50"
            >
              Cancelar
            </button>
          </div>
