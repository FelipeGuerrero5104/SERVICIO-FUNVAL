...
const StudentRegistrationForm = ({ onLogout, currentUserId }) => {
    ...
    const validateForm = () => {
        ...
        if (!formData.student_id.trim()) { newErrors.student_id = 'El ID del estudiante es obligatorio.'; isValid = false; } else if (!/^[0-9]+$/.test(formData.student_id.trim())) { newErrors.student_id = 'El ID del estudiante debe ser numérico.'; isValid = false; }
