...
const UpdateProfile = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.f_lastname.trim())
      newErrors.f_lastname = "El apellido paterno es obligatorio.";
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Respuesta de UpdateProfile:", {
      ...
      if (
        ...
        setSubmissionMessage({
          type: "error",
          text: `Respuesta inesperada del servidor: ${response.status}`,
        });
      }
    } catch (error) {
      ...
      <div className="bg-white rounded-xl shadow-2xl p-8 max-w-md w-full dark:bg-[#121212]">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            />
            {errors.f_name && (
              <p className="text-red-600 text-sm mt-1">{errors.f_name}</p>
            )}
          </div>
          <div className="mb-4">
            <label
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-[#1d1d1d] dark:text-white"
            />
          </div>
          <div className="mb-4">
            <label
            ...
            />
            {errors.f_lastname && (
              <p className="text-red-600 text-sm mt-1">{errors.f_lastname}</p>
            )}
          </div>
          <div className="mb-4">
            <label
